      ...
      inner.innerHTML =
        '<div class="space-y-4">' +
          ...
          (function() {
            ...
            return '<div>' +
              '<p style="font-size:11px;font-weight:700;color:#60a5fa;text-transform:uppercase;letter-spacing:.05em;margin-bottom:8px">⚡ Generadas en campo (' + generadas.length + ')</p>' +
              '<div class="space-y-2">' +
                generadas.map(function(o) {
                  ...
                  return '<div style="background:white;border:1.5px solid #BFDBFE;border-radius:10px;padding:10px 12px">' +
                    '<div style="display:flex;align-items:center;justify-content:space-between;gap:8px">' +
                      ...
                      '</div>' +
                      '<span style="font-size:10px;font-weight:700;padding:2px 8px;border-radius:20px;background:rgba(96,165,250,.15);color:#60a5fa;white-space:nowrap;flex-shrink:0">Campo</span>' +
                    '</div>' +
                  '</div>';
                }).join('') +
              '</div>' +
